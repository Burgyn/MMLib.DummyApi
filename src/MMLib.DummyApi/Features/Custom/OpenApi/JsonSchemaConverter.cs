...
{
    /// <summary>
    /// Converts a JSON Schema element to an <see cref="IOpenApiSchema"/>.
    /// </summary>
    /// <param name="schemaElement">The JSON schema element to convert.</param>
    ...
    /// <summary>
    /// Converts a collection name to PascalCase schema name (e.g., "products" -> "Products").
    /// </summary>
